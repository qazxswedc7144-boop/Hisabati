...
export const SendMessageModal: React.FC = () => {
  ...
  useEffect(() => {
    if (activeRecipientAccount) {
      ...
      const balanceStr = formatNumber(amountVal, 2);
      ...
      setVariables({
        ...
        totalDebit: formatNumber(activeRecipientAccount.totalDebit, 2),
        totalCredit: formatNumber(activeRecipientAccount.totalCredit, 2),
  ...
  const handleAccountChange = (accId: string) => {
    ...
    if (acc) {
      ...
      setVariables((prev) => ({
        ...
        totalDebit: formatNumber(acc.totalDebit, 2),
        totalCredit: formatNumber(acc.totalCredit, 2),
      }));
    }
  };
