        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm sm:text-base font-black text-slate-900 dark:text-slate-100 flex items-center gap-2">
              <span>مسودات الفواتير المحفوظة ذكيًا (OCR)</span>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
              الفواتير التي تم مسحها بالكاميرا ولم يتم اعتمادها بعد.
            </p>
          </div>
        </div>
      ...
      {savedDrafts.length === 0 ? (
        <div className="py-8 text-center rounded-2xl border border-dashed border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/30 p-4">
          ...
          <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1 max-w-sm mx-auto">
            يمكنك مسح فاتورة بالكاميرا ومراجعتها قبل اعتمادها.
          </p>
          <button
            type="button"
            onClick={openScannerModal}
            className="mt-3 inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-bold text-sky-700 dark:text-sky-300 bg-sky-50 dark:bg-sky-950/50 hover:bg-sky-100 dark:hover:bg-sky-900/60 border border-sky-200/60 dark:border-sky-800/60 transition min-h-[40px]"
          >
            <Plus className="w-3.5 h-3.5" />
            <span>+ مسح فاتورة تجريبية</span>
          </button>
        </div>
      ) : (
