...
export const ReceiptToTransactionModal: React.FC<ReceiptToTransactionModalProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl w-full max-w-xl max-h-[92dvh] flex flex-col shadow-2xl overflow-hidden my-auto">
        {/* Modal Header */}
