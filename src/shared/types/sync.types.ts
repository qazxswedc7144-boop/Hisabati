...
export interface BackupMetadata {
  ...
  /**
   * Dexie database schema version from which this backup was created.
   */
  databaseSchemaVersion: number;

  /**
   * Financial data representation version.
   * Version 1 = existing decimal number representation.
   */
  financialFormatVersion: number;

  /**
   * Legacy field kept temporarily for old backup compatibility.
   */
  schemaVersion?: number;

  /**
   * Original schema version prior to in-memory migration (if migrated).
   */
