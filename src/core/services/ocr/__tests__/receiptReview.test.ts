...
const mockOCRResult: OCRResult = {
  ...
  documentType: { value: 'invoice', confidence: 0.9, source: 'heuristic' },
  vendorName: { value: 'مؤسسة الأمل للتجارة العامة', confidence: 0.95, source: 'heuristic' },
  customerName: { value: 'مؤسسة الريان', confidence: 0.85, source: 'heuristic' },
  invoiceNumber: { value: 'INV-2026-904', confidence: 0.92, source: 'heuristic' },
  date: { value: '2026-05-14', confidence: 0.9, source: 'heuristic' },
  currency: { value: 'YER', confidence: 0.95, source: 'heuristic' },
  subtotal: { value: 22000, confidence: 0.85, source: 'heuristic' },
  tax: { value: 0, confidence: 0.9, source: 'heuristic' },
  totalAmount: { value: 22000, confidence: 0.98, source: 'heuristic' },
  totalAmountMinor: { value: 2200000, confidence: 0.98, source: 'heuristic' },
  lineItems: [
    {
      id: 'item-1',
      name: { value: 'سكر أبيض 10كجم', confidence: 0.9, source: 'heuristic' },
      quantity: { value: 2, confidence: 0.85, source: 'heuristic' },
      unitPrice: { value: 4000, confidence: 0.85, source: 'heuristic' },
      unitPriceMinor: { value: 400000, confidence: 0.85, source: 'heuristic' },
      totalPrice: { value: 8000, confidence: 0.9, source: 'heuristic' },
      totalPriceMinor: { value: 800000, confidence: 0.9, source: 'heuristic' },
    },
    {
      id: 'item-2',
      name: { value: 'أرز بسمتي 5كجم', confidence: 0.9, source: 'heuristic' },
      quantity: { value: 3, confidence: 0.85, source: 'heuristic' },
      unitPrice: { value: 3000, confidence: 0.85, source: 'heuristic' },
      unitPriceMinor: { value: 300000, confidence: 0.85, source: 'heuristic' },
      totalPrice: { value: 9000, confidence: 0.9, source: 'heuristic' },
      totalPriceMinor: { value: 900000, confidence: 0.9, source: 'heuristic' },
    },
    {
      id: 'item-3',
      name: { value: 'زيت طبخ 4لتر', confidence: 0.9, source: 'heuristic' },
      quantity: { value: 1, confidence: 0.85, source: 'heuristic' },
      unitPrice: { value: 5000, confidence: 0.85, source: 'heuristic' },
      unitPriceMinor: { value: 500000, confidence: 0.85, source: 'heuristic' },
      totalPrice: { value: 5000, confidence: 0.9, source: 'heuristic' },
      totalPriceMinor: { value: 500000, confidence: 0.9, source: 'heuristic' },
    },
  ],
...
const sparseOCR: OCRResult = {
  ...
  processingTimeMs: 50,
  isUserConfirmed: false,
  documentType: { value: 'unknown', confidence: 0.2, source: 'heuristic' },
  currency: { value: 'YER', confidence: 0.5, source: 'heuristic' },
  vendorName: { value: null as any, confidence: 0, source: 'heuristic' },
  customerName: { value: null as any, confidence: 0, source: 'heuristic' },
  invoiceNumber: { value: null as any, confidence: 0, source: 'heuristic' },
  date: { value: null as any, confidence: 0, source: 'heuristic' },
  totalAmount: { value: null as any, confidence: 0, source: 'heuristic' },
  totalAmountMinor: { value: null as any, confidence: 0, source: 'heuristic' },
  lineItems: [],
...
const lowConfidenceOCR: OCRResult = {
  ...mockOCRResult,
  vendorName: { value: 'متجر غير واضح', confidence: 0.45, source: 'heuristic' },
  totalAmount: { value: 1500, confidence: 0.55, source: 'heuristic' },
};
